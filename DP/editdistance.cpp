...
*/
//see the moscow notebook, cp handbook and coursera lecture week 5 (algorithmic toolbox)
#include <bits/stdc++.h>
using namespace std;
...
void output_process(int i, int j, const vector<vector<int> >& dp)
{
	...
	else
	{
		...
		if (a[i] == b[j]) cout << "leave " << a[i] << " as it is\n";
...
int main()
{
	...
	a = string(sz(tmpa) + 1, '\0'), b = string(sz(tmpb) + 1, '\0');
